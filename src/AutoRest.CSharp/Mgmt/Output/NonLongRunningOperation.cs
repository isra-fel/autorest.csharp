...
namespace AutoRest.CSharp.Mgmt.Output
{
    ...
    /// </summary>
    internal class NonLongRunningOperation : LongRunningOperationBase
    {
        public NonLongRunningOperation(OperationGroup operationGroup, Operation operation, BuildContext<MgmtOutputLibrary> context, LongRunningOperationInfo lroInfo) : base(operation, context, lroInfo)
        {
